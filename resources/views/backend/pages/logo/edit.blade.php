...
@section('main-content')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Logo/</span> edit Logo</h4>
    <div class="row">
        <div class="col-xxl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('logo.update', ['logo' => $logo->id]) }}" method="POST"
                        enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <input type="hidden" name="logoeditid" value="{{ $logo->id }}">
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="logo_name" name="logo_name"
                                    placeholder="logo text" value="{{ $logo->logo_name }}">
                                @error('logo_name')
