            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('blog.update', ['blog' => $blog->id]) }}" method="POST"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="blog_bigheading" name="blog_bigheading"
                                    placeholder="blog big heading" value="{{ $blog->blog_bigheading }}">
                        ...
                        <div class="row mb-3">
                            <label class="col-sm-2 col-form-label" for="">blog Image(preview)</label>
                            <div class="col-sm-10">
                                <img src="{{ asset($blog->blog_bgimage) }}" class=" img-fluid img-thumbnail"
